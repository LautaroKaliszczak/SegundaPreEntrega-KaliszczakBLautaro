...
public class ClienteController {
	...
	/*@PostMapping("/comprar-producto")
	    public ResponseEntity<Cliente> comprarProducto(@RequestBody CompraProductosDTO compraProductoDTO) {
	        try {
	            Cliente cliente = clienteService.comprarProducto(compraProductoDTO);
	            return ResponseEntity.ok(cliente);
	        } catch (IllegalArgumentException e) {
